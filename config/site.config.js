...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'ignacioemm.xe@outlook.com',
  ...
  protectedRoutes: ['/Resource/onlyfans'],

  // [OPTIONAL] Use "" here if you want to remove this email address from the nav bar.
  email: 'mailto:telly3e@outlook.com',
